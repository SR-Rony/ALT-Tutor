...
export function PastPaperTakePage({ programSlug, paperSlug }: Props) {
  ...
  const resultHref = useCallback(
    (attemptId: string) => ROUTES.subjectPastPaperResult(programSlug, paperSlug, attemptId),
    [programSlug, paperSlug]
  );
  ...
  return (
    <div className="bg-background pb-24">
      <ResourceHero
        ...
        subtitle={`${programName} · ${payload.paper.year} ${payload.paper.paperCode}`}
        description="Fixed question set. Mark schemes stay locked until you submit."
